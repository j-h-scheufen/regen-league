...
export default function ProjectMain() {
  const [projectRoles, initialProjectCandidates] = useAtomValue(
    waitForAll([projectRolesAtom, projectMemberCandidatesAtom])
  );
  ...
  if (!currentProject) throw Error("No project object detected in app state!");
      ...
      <Box width="large">
        ...
        {edit ? (
          <Box>
            ...
            />
            <ProjectAttributesForm project={currentProject} />
            <LocationForm entity={currentProject} update={updateLocation} />
            <RegionSelectorPanel ownerId={currentProject.id} />
            <LinksForm ownerId={currentProject.id} />
            <MembersForm
