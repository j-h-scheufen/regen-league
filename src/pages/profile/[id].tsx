...
export default function ProfilePage({ profile, hubs, projects }: InferGetServerSidePropsType<typeof getServerSideProps>) {
    if (!profile)
        throw new Error('This component requires a profile')
  return (
